            ...
            [
                ...
                html.Div(  # 유저 프로필 -- 추가 정보
                    [
                        ...
                        html.Div(
                            "accepted_movie", className="col-start-3 col-end-4 p-2"
                        ),
                        html.Div(
                            children=[],
                            id="user-movie+",
                        ...
                        html.Div(
                            "rejected_movies", className="col-start-3 col-end-4 p-2"
                        ),
                        html.Div(
                            children=[],
                            id="user-movies-",
                        ...
                        html.Div(
                            "rejected_music", className="col-start-3 col-end-4 p-2"
                        ),
                        html.Div(
                            children=[],
                            id="user-music-",
                        ...
                        html.Div("rejected", className="col-start-3 col-end-4 p-2"),
                        html.Div(
                            children=[],
                            id="user-reject",
                            className="user-info col-start-4 col-end-5",
                        ...
                        html.Div("accepted_poi", className="col-start-3 col-end-4 p-2"),
                        html.Div(
                            children=[],
                            id="user-poi+",
                            className="user-info col-start-4 col-end-5",
                        ...
                        html.Div(
                            "accepted_news", className="col-start-3 col-end-4 p-2"
                        ),
                        html.Div(
                            children=[],
                            id="user-news+",
