        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink(
                    [
                        html.Span(
                            className="bi bi-columns", style={"padding": "0vh 1vw"}
                        ),
...
layout_style = {"display": "horizontal"}
app.layout = html.Div(
    [
        html.Span(
            [sidebar, html.Div([header, dash.page_container])],
            style={"display": "flex"},
        )
    ],
    style=layout_style,
...
if __name__ == "__main__":
    app.run_server(debug=True, port=30001)
