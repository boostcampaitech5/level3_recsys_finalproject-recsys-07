...
flags.DEFINE_string("multiwoz21_data_dir", None, "Path of the MultiWOZ 2.1 dataset.")
...
_UNTRACKED_SLOTS = frozenset(
    {
        ...
        "train-booktrainid",
        "taxi-booktype",
        "restaurant-bookreference",
        "hospital-bookreference",
        "hotel-bookreference",
        "train-bookreference",
        "hospital-booktime",
    }
...
def get_slot_name(slot_name, service_name, in_book_field=False):
    ...
    slot_name = (
        "book" + slot_name
        if in_book_field and slot_name != "department" and slot_name != "name"
        else slot_name
    )
